<p align="center">
  <h1 align="center">⚗️ POE2 物价补丁 v0.4.9.5</h1>
...
`v0.4.9.5` 优化国内下载环境：发布包自带 .NET 8.0.28 离线修复压缩包，正常不再联网下载 .NET；Python 自动修复优先使用国内镜像，官方源作为最终备用。每个文件仍必须通过固定 SHA 校验，并完整保留 v0.4.9.4 的隔离构建、缓存降级、写后校验和自动还原安全链路。
