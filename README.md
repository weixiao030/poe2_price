...
> 💡 **提示：** “自动识别”会优先检查补丁文件夹上一级，然后检查已安装程序信息、Steam 游戏库、Epic 清单和常见安装位置；未识别到或电脑上有多个客户端时，可切换到“手动选择游戏文件夹”。选定目录后，工具仍会自动判断官服 GGPK、Steam/Epic Bundles2 或国服 WeGame Bundles2。

### 3. 使用

1. **关闭游戏**
2. 双击 `一键更新物价补丁.exe`
3. 在弹窗中选择“自动识别游戏文件夹”或“手动选择游戏文件夹”，并选择本次要写入的补丁范围；“岛屿传言提示”默认勾选，如本次不需要可取消
