<p align="center">
  <h1 align="center">⚗️ POE1/2 物价补丁 v0.6.1</h1>
...
`v0.6.1` 修复自动识别模式下赛季控件被隐藏的问题：赛季选择固定显示在“游戏版本”右侧，并根据自动识别客户端下拉框中的 POE1/POE2 目标实时切换对应赛季目录；默认选择最新赛季。此前 `v0.6.0` 的运行时赛季发现、赛季标识配对和缓存隔离继续保留。
